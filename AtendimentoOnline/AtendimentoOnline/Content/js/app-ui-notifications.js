  ...
  App.uiNotifications = function( ){  
    ...
    $('#not-basic').click(function(){
      $.gritter.add({
        ...
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/avatar.png',
        time: '',
    ...
    $('#not-theme').click(function(){
      $.gritter.add({
        ...
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/avatar5.png',
    ...
    $('#not-sticky').click(function(){
      $.gritter.add({
        ...
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/slack_logo.png',
        class_name: 'clean',
        sticky: true, 
        time: ''
      });
    ...
    $('#not-facebook').click(function(){
      $.gritter.add({
        ...
        text: 'You can start your day checking the new messages.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/fb-icon.png',
    ...
    $('#not-twitter').click(function(){
      $.gritter.add({
        ...
        text: 'You can start your day checking the new messages.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/tw-icon.png',
    ...
    $('#not-google-plus').click(function(){
      $.gritter.add({
        ...
        text: 'You can start your day checking the new messages.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/gp-icon.png',
    ...
    $('#not-dribbble').click(function(){
      $.gritter.add({
        ...
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/db-icon.png',
    ...
    $('#not-flickr').click(function(){
      $.gritter.add({
        title: 'You have new comments!',
        text: 'You can start your day checking the new comments.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/fl-icon.png',
    ...
    $('#not-linkedin').click(function(){
      $.gritter.add({
        title: 'You have new comments!',
        text: 'You can start your day checking the new comments.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/in-icon.png',
    ...
    $('#not-youtube').click(function(){
      $.gritter.add({
        title: 'You have new comments!',
        text: 'You can start your day checking the new comments.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/yt-icon.png',
    ...
    $('#not-pinterest').click(function(){
      $.gritter.add({
        title: 'You have new comments!',
        text: 'You can start your day checking the new comments.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/pi-icon.png',
    ...
    $('#not-github').click(function(){
      $.gritter.add({
        ...
        text: 'You can start your day checking the new comments.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/gh-icon.png',
    ...
    $('#not-tumblr').click(function(){
      $.gritter.add({
        title: 'You have new comments!',
        text: 'You can start your day checking the new comments.',
        image: App.conf.ContentPath + '/' +  App.conf.imgPath + '/tu-icon.png',
